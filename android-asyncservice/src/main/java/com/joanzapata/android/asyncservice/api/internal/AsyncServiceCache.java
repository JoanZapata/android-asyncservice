...
public final class AsyncServiceCache {
    ...
    private static final String TAG = AsyncServiceCache.class.getSimpleName();
    ...
    private synchronized static boolean isReady() {
        ...
        if (AsyncService.context == null) return false;
        return initialize();
    }
    ...
    private static boolean initialize() {
        try {
            ...
            String path = AsyncService.context.getFilesDir().getAbsolutePath() + File.separator + "asyncservicedb";
